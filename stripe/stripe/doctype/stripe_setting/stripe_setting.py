...
class StripeSetting(Document):
	...
	def on_update(self):
		create_payment_gateway('Stripe-' + self.gateway_name, settings='Stripe Setting', controller=self.gateway_name)
	...
	def get_payment_url(self, **kwargs):
		return get_url("./stripe_checkout?{0}".format(urlencode(kwargs)))
